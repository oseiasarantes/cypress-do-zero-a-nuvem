describe('Central de Atendimento ao Cliente TAT', () => {
  ...
  it('preenche os campos obrigatórios e envia o formulário', () => {  
    ...
    cy.get('.success').should('be.visible').invoke('show').and('contain', 'Mensagem enviada com sucesso.');
  ...
  it('exibe erro quando telefone é obrigatório, mas não é informado', () => {
    ...
    cy.get('.error').should('be.visible').invoke('show').and('contain', 'Valide os campos obrigatórios!');
  ...
  it('enviar um formulário usando um comando personalizável que possui argumentos', () => {
    ...
    cy.preencheCamposComValoresObrigatoriosPadraoOuPorArgumento();
    cy.get('.success').should('be.visible');
  ...
  it.only('Encontre o gato', () => {
    cy.get('#cat').invoke('show').should('be.visible').invoke('hide');
  })
